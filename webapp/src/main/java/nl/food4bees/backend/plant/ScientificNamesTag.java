...
public class ScientificNamesTag extends SimpleTagSupport
{
    static private String sourceClass = ScientificNamesTag.class.getName();
    static private Logger logger = Logger.getLogger(sourceClass);

    public void doTag() throws JspException, IOException
    {
        try {
            List<ScientificName> list = new Database().getScientificNamesList();
